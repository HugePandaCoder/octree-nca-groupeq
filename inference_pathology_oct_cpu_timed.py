...
model_path = "/local/scratch/clmn1/octree_study_new/Experiments/pesofAbl_none_10_1.5_16_3_1.0_0.99_OctreeNCA2DSegmentation"
...
def measure_time_and_print():
    seed, slide, computed_resolutions = load_sample()
