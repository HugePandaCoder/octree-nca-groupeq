...
config = [{
    ...
    'model_path': r'M:\MasterThesis\Git\NCA\models\NCA_Test41_dataloader_c16_l16e4_opt_prostate_full_andScale7',
    'device':"cuda:0",
    'n_epoch': 200,
    # Learning rate
    'lr': 16e-4, #16e-4,
...
ca = CAModel_optimizedTraining(config[0]['channel_n'], config[0]['cell_fire_rate'], device, hidden_size=8).to(device)
