...
from src.losses.LossFunctions import DiceLoss, DiceBCELoss, DiceFocalLoss, DiceBCELoss_Distance, DiceLoss_mask
...
config = [{
    ...
    'model_path': r'/home/jkalkhof_locale/Documents/Models/TestNCA_Pathology3_only4Classes_learntP_3_betas',
    'device':"cuda:0",
    'n_epoch': 15000,
    # Learning rate
    'lr': 0.001,
...
#exit()
loss_function = DiceLoss_mask()
exp.temporarly_overwrite_config(config)
#agent.getAverageDiceScore()
with torch.no_grad():
    agent.test(loss_function, save_img = [])
