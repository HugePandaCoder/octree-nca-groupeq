...
config = [{
    ...
    'img_path': r"M:/MasterThesis/Datasets/cmr_challenge_tiny/imagesTr",
    'label_path': r"M:/MasterThesis/Datasets/HepaticVessel_tiny/labelsTr/",
    'data_type': '.nii.gz', # .nii.gz, .jpg
    'model_path': r'M:/Models/TestNCA_CMR',
    'device':"cuda:0",
    'n_epoch': 10,
    # Learning rate
    'lr': 16e-4,
