...
if EXPORT_VIDEO:
    ...
    if CUDA:
        out_path = "/local/scratch/clmn1/octree_study_new/qualitative/inference2_cholec_oct_cuda.mp4"
    else:
        out_path = "/local/scratch/clmn1/octree_study_new/qualitative/inference2_cholec_oct.mp4"
...
if EXPORT_AS_ARRAY:
    ...
    np.save("/local/scratch/clmn1/octree_study_new/qualitative/inference2_cholec_oct.npy", seg_array)