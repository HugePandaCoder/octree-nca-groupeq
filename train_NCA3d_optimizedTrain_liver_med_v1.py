...
config = [{
    ...
    'model_path': r'/home/jkalkhof_locale/Documents/Models/NCA3d_optVRAM_liver_medNCA_Test1', #94
    'device':"cuda:0",
    'n_epoch': 25000,
    # Learning rate
    'lr': 16e-4,
    ...
    'output_channels': 1,
    # Data
    'input_size': [(64, 64), (256, 256)], #[(40, 40, 3), (80, 80, 6), (160, 160, 12), (320, 320, 24)] ,
    'scaling_factor': 4,
