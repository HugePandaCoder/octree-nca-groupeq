...
config = [{
    ...
    'model_path': r'/home/jkalkhof_locale/Documents/Models/UNet_hippocampus_efficientNet_v1',
    'device':"cuda:0",
    'n_epoch': 1000,
    # Learning rate
    'lr': 1e-4,
...
ca = smp.Unet("efficientnet-b0", classes=3, encoder_weights=None).to(device)
