...
config = [{
    'img_path': r"/home/jkalkhof_locale/Downloads/test_seg/images/",
    'label_path': r"/home/jkalkhof_locale/Downloads/test_seg/labels/",
    'name': r'Med_NCA_Run13_Xray_Lung', #12 or 13, 54 opt, 
    'device':"cuda:0",
    'unlock_CPU': True,
    # Optimizer
    'lr': 16e-4,
