...
from src.utils.BaselineConfigs import EXP_SegFormer2D
...
study_config = {
    'experiment.name': r'peso_vit',
    'experiment.description': "SegFomer2DSegmentation",
...
exp = EXP_SegFormer2D().createExperiment(study_config, detail_config={}, dataset_class=Dataset_PESO, dataset_args={
