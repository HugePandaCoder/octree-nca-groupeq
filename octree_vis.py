...
@torch.no_grad()
def visualize(experiment: Experiment) -> plt.Figure:
    if isinstance(experiment.model, OctreeNCA):
        return visualize2d(experiment)
    else:
        return visualize3d(experiment)


@torch.no_grad()
def visualize2d(experiment: Experiment) -> plt.Figure:
...
@torch.no_grad()
def visualize3d(experiment: Experiment) -> plt.Figure:
