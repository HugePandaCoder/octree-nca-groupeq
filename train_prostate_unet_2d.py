...
study_config = {
    'experiment.name': r'new_prostate_unet_2d_1',
...
study_config['experiment.dataset.patchify'] = False
study_config['experiment.dataset.patchify.foreground_oversampling_probability'] = 0.5
study_config['experiment.dataset.patchify.patch_size'] = [160, 160]

study_config['model.eval.patch_wise'] = True

study_config['experiment.dataset.slice'] = 3
...
raise NotImplementedError("Loading the split created by a 3D experiment into a 2D experiment does not work!")
exp = EXP_UNet2D().createExperiment(study_config, detail_config={}, dataset_class=Dataset_NiiGz_3D, dataset_args={
