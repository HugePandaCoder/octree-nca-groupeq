...
config = [{
    ...
    'name': r'Med_NCA_Run1_ChestX8_50', #12 or 13, 54 opt, 
    'device':"cuda:0",
    'unlock_CPU': True,
    # Optimizer
    'lr': 16e-4,
...
if True:
    ...
    #hyp99_test = Dataset_NiiGz_customPath(resize=True, slice=2, size=(256, 256), imagePath=r"/home/jkalkhof_locale/Documents/MICCAI24_finetuning/ChestX8_50_finetune/ChestX8_50/images", labelPath=r"/home/jkalkhof_locale/Documents/MICCAI24_finetuning/ChestX8_50_finetune/ChestX8_50/labels")
    hyp99_test = Dataset_NiiGz_customPath(resize=True, slice=2, size=(256, 256), imagePath=r"/home/jkalkhof_locale/Documents/MICCAI24_finetuning/ChestX8_50_finetune/Padchest_50/images_test", labelPath=r"/home/jkalkhof_locale/Documents/MICCAI24_finetuning/ChestX8_50_finetune/Padchest_50/labels_test")
