...
config = [{
    ...
    'model_path': r'/home/jkalkhof_locale/Documents/Models/Models/UNet_Hippocampus_MedSeg_1_ResNet18',
    'device':"cuda:0",
    'n_epoch': 1000,
    # Learning rate
    'lr': 1e-4,
...
ca = smp.Unet(encoder_name='resnet18', encoder_weights=None, in_channels=1, classes=1).to(device)
