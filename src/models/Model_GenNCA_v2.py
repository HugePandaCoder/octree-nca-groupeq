...
class HyperNetwork(nn.Module):
    def __init__(self, input_size, channel_n, kernel_size, hidden_size):
        ...
        self.lin01 = nn.Linear(input_size, 16)
        self.lin02 = nn.Linear(16+input_size, 256)
        self.lin03 = nn.Linear(256+input_size, 256**2)
        self.lin04 = nn.Linear(256**2+input_size, 256)
