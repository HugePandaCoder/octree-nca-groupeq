...
class DiffusionNCA_Group(BackboneNCA):
    ...
    def __init__(self, channel_n, fire_rate, device, hidden_size=128, input_channels=1, drop_out_rate=0.25, img_size=28):
        r"""Init function
        """
        super(DiffusionNCA_Group, self).__init__(channel_n, fire_rate, device, hidden_size)
        self.drop0 = nn.Dropout(drop_out_rate)
        self.group0 = nn.GroupNorm(num_groups =  1, num_channels=hidden_size)
