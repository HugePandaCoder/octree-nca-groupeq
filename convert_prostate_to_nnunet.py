...
INPUT_PATH = "/local/scratch/clmn1/cardiacProstate/nnUnet_raw_data_base/Prostate_MEDSeg"
OUT_PATH = "/local/scratch/clmn1/cardiacProstate/nnUnet_raw_data_base/nnUNet_raw_data/Task507_Prostate_MEDSeg"
