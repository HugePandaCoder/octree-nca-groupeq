...
study_config['model.checkpoint'] = "/local/scratch/clmn1/sam_checkpoints/sam2/sam2_hiera_base_plus.pt"
study_config['model.model_cfg'] = "configs/sam2/sam2_hiera_b+.yaml"

study_config['model.checkpoint'] = "/local/scratch/clmn1/sam_checkpoints/sam2/sam2_hiera_small.pt"
study_config['model.model_cfg'] = "configs/sam2/sam2_hiera_s.yaml"

study_config['model.checkpoint'] = "/local/scratch/clmn1/sam_checkpoints/sam2/sam2_hiera_tiny.pt"
