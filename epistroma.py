from src.datasets.Dataset_Epistroma import Dataset_Epistroma
...
study_config = {
    'img_path': r"/local/scratch/clmn1/data/epi_processed/epistroma_train.pytable",
    'label_path': r"/local/scratch/clmn1/data/epi_processed/epistroma_train.pytable",
        'name': r'epistroma_3',
        'device':"cuda:0",
        'unlock_CPU': True,
        # Optimizer
...
study.add_experiment(EXP_OctreeNCA().createExperiment(study_config, detail_config={}, 
                                                      dataset_class=Dataset_Epistroma, dataset_args={
                                                      }))
